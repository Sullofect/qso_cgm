...
bkg_OII = Background2D(data_OII, (50, 50), filter_size=(3, 3), bkg_estimator=bkg_estimator)
bkg_OIII = Background2D(data_OIII, (50, 50), filter_size=(3, 3), bkg_estimator=bkg_estimator)
...
ax1.imshow(data_OIII_convolved_seg, origin='lower', cmap='Reds', norm=norm)
ax1.plot(x_OIII, y_OIII, '*', ms=10)
ax1.plot(x_OIII_convolved, y_OIII_convolved, '.k', ms=10)
ax1.set_title('Background-subtracted Data')
ax2.imshow(segment_map_OIII, origin='lower', cmap=segment_map_OIII.cmap, interpolation='nearest')
ax2.set_title('Segmentation Image')
ax3.imshow(segment_map_data_OIII, origin='lower', interpolation='nearest')
ax3.plot(x_OIII, y_OIII, '*', ms=10)
