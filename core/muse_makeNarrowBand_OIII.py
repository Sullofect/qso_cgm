...
from muse_MakeGasImages import ConvertFits
...
# OIII
path_cube_OIII = '/Users/lzq/Dropbox/Data/CGM/cube_narrow/CUBE_OIII_line_offset.fits'
...
# Plot the data
# Read region file
path_region = '/Users/lzq/Dropbox/Data/CGM/regions/gas_list_revised.reg'
...
#
path_label = '/Users/lzq/Dropbox/Data/CGM/regions/gas_label_list.reg'
...
def MakeOIIIMap(gal=False, region=False, video=False):
    for i in range(6):
        ...
        if region:
            ...
            gc.show_contour(path_subcube, levels=[0.15, 0.3], colors='k', linewidths=0.8, smooth=3)
