...
class SourceMorphology(object):
    ...
    def __init__(self, image, segmap, label, mask=None, weightmap=None,
                 ...
                 verbose=False, x_qso=None, y_qso=None):
        self._image = image
        self._segmap = segmap
        self.label = label
        self._mask = mask
        ...
        self.x_qso, self.y_qso = x_qso, y_qso
    ...
    def _centroid(self):
        ...
        return np.array([self.x_qso - self.xmin_stamp, self.y_qso - self.ymin_stamp])
    ...
    def _asymmetry_center(self):
        ...
        # return center_asym
        return [self.x_qso - self.xmin_stamp, self.y_qso - self.ymin_stamp]
