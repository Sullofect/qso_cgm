...
def FixAstrometry(cubename=None, thr_hst=3, thr_muse=3, deblend_hst=False, deblend_muse=True,
    ...
    path_savefig = '../../MUSEQuBES+CUBS/plots/{}_offset_gaia.png'.format(cubename)
    path_savefig_MUSE = '../../MUSEQuBES+CUBS/plots/{}_MUSE_WHITE_gaia.png'.format(cubename)
    path_savefig_vect_MUSE = '../../MUSEQuBES+CUBS/plots/{}_MUSE_vector.png'.format(cubename)
    path_savefig_vect_hst = '../../MUSEQuBES+CUBS/plots/{}_HST_vector_rot.png'.format(cubename)
    path_savefig_check_MUSE = '../../MUSEQuBES+CUBS/plots/{}_MUSE_checkcoord.png'.format(cubename)
    path_savefig_check_hst = '../../MUSEQuBES+CUBS/plots/{}_HST_checkcoord.png'.format(cubename)
    ...
    #
    path_gal = '../../MUSEQuBES+CUBS/gal_info/{}_gal_info.fits'.format(cubename)
    ...
    # Gaia
    path_gaia = '../../MUSEQuBES+CUBS/astrometry/GAIA_{}.txt'.format(cubename)
    ...
    # LS
    path_ls = '../../MUSEQuBES+CUBS/astrometry/LS_{}.txt'.format(cubename)
    ...
    path_hst_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_drc_offset_gaia.fits'.format(cubename)
    path_muse_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia.fits'.format(cubename)
    path_muse_white_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(
        cubename)
    ...
    if os.path.exists(path_muse_white_gaia) is True and os.path.exists(path_hst_gaia) is True:
        ...
        offset_ra_hst_1, offset_dec_hst_1 = (c_qso.ra - c2_hst.ra[idx_qso]).value, (
                    c_qso.dec - c2_hst.dec[idx_qso]).value
        ...
        # Save offsets
        path_offset = '../../MUSEQuBES+CUBS/astrometry/offsets.dat'
        ...
        path_muse = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP.fits'.format(cubename)
        path_muse_white = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_WHITE.fits'.format(cubename)
        ...
        offset_ra_muse, offset_dec_muse = (c_qso.ra - c2_muse.ra[idx_qso]).value, (
                    c_qso.dec - c2_muse.dec[idx_qso]).value
...
def FixDat(cubename=None):
    ...
    #
    path_dat = '../../MUSEQuBES+CUBS/dats/{}_ESO-DEEP_ZAP.dat'.format(cubename)
    path_dat_gaia = '../../MUSEQuBES+CUBS/dats/{}_ESO-DEEP_ZAP_gaia.dat'.format(cubename)
    path_reg_gaia = '../../MUSEQuBES+CUBS/dats/{}_ESO-DEEP_ZAP_gaia.reg'.format(cubename)
    ...
    reg_main = list(map(''.join, zip(np.full_like(array_like, 'circle(', dtype='<U15'),
                                     ...
                                     np.asarray(dat['radius'], dtype=str),
                                     np.full_like(array_like, '") # text={', dtype='<U15'),
...
def CopyCurrentObj(cubename=None):
    # Object files
    path_obj = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_spec1D'.format(cubename)
    path_obj_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_spec1D'.format(cubename)
    ...
    path_dat = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP.dat'.format(cubename)
    path_dat_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia.dat'.format(cubename)
    dat = ascii.read(path_dat, format='fixed_width')
...
def FixWithAstrometry(cubename=None, FixHST=False, FixMUSE=True, CheckHST=False, CheckMUSE=False, thr_hst=3, thr_muse=3,
    ...
    path_muse = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia.fits'.format(cubename)
    path_muse_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia.fits'.format(cubename)
    path_muse_white = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(cubename)
    path_muse_white_astro = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE_astro.fits'.format(
        cubename)
    path_muse_white_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(
        cubename)
    path_muse_white_gaia_astro = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia_WHITE_astro.fits'.format(
        cubename)
    #
    path_hst = '../../MUSEQuBES+CUBS/datacubes/{}_drc_offset_gaia.fits'.format(cubename)
    path_hst_astro = '../../MUSEQuBES+CUBS/datacubes/{}_drc_offset_gaia_astro.fits'.format(cubename)
    ...
    if os.path.exists(path_muse_white_gaia) is True and os.path.exists(path_hst_gaia) is True:
        ...
        if FixMUSE:
            ...
            hdul_muse_white[1].header['CD1_1'] = hdul_muse_white[1].header['PC1_1'] * hdul_muse_white[1].header[
                'CDELT1']
            hdul_muse_white[1].header['CD2_1'] = hdul_muse_white[1].header['PC2_1'] * hdul_muse_white[1].header[
                'CDELT2']
            hdul_muse_white[1].header['CD1_2'] = hdul_muse_white[1].header['PC1_2'] * hdul_muse_white[1].header[
                'CDELT1']
            hdul_muse_white[1].header['CD2_2'] = hdul_muse_white[1].header['PC2_2'] * hdul_muse_white[1].header[
                'CDELT2']
            ...
            c2_muse_ls = c2_muse[sep_constraint]
            c_ls_muse = c_ls[idx_muse_ls[sep_constraint]]
            offset_ra_muse_2, offset_dec_muse_2 = (c_ls_muse.ra - c2_muse_ls.ra).value, (
                        c_ls_muse.dec - c2_muse_ls.dec).value
        ...
        if FixHST:
            os.system('astrometry {} -c {} -hdul_idx 1 '
                      '--sigma_threshold_for_source_detection {} -fine 0 -high_res True'.format(path_hst, path_ls,
                                                                                                thr_hst))
