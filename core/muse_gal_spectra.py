...
def PlotGalSpectra(row_array=None, qls=False, figname='spectra_gal'):
    ...
    for i in range(len(row_array)):
        ...
        axarr_0.annotate(text=r'$\mathrm{[O \, II]}$', xy=(0.2, 0.75), xycoords='axes fraction', size=20)
        axarr_0.annotate(text=r'$\mathrm{K, H, G}$', xy=(0.39, 0.75), xycoords='axes fraction', size=20)
        axarr_0.annotate(text=r'$\mathrm{H\beta}$', xy=(0.65, 0.75), xycoords='axes fraction', size=20)
        axarr_0.annotate(text=r'$\mathrm{[O \, III]}$', xy=(0.78, 0.75), xycoords='axes fraction', size=20)
