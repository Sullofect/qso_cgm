...
def RecalculateCentroid(cubename=None, deblend_hst=False, thr_hst=3):
    ...
    # data_hst_gaia = data_hst_gaia[1750:2250, 1750:2250]
    # error_hst_gaia = error_hst_gaia[1750:2250, 1750:2250]
...
RecalculateCentroid(cubename='HE0226-4110', deblend_hst=True, thr_hst=0.9)
