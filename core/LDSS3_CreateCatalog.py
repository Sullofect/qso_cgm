...
def CreateAlignStar(dir=None, dir2='', dir3='', filename=None):
    # Select alignment stars
    path_LS = fits.open('../../MaskDesign/{}_mask{}/{}.fits'.format(dir, dir2, filename))
    ...
    try:
        ...
        ra_Gaia, dec_Gaia = data_LS['ra_3'], data_LS['dec_3']
    ...
    # * .dat file
    path_star_dat = '../../MaskDesign/{}_mask{}/{}{}_*.dat'.format(dir, dir2, dir, dir3)
    ...
    # * .reg file
    path_star_reg = '../../MaskDesign/{}_mask{}/{}{}_star.reg'.format(dir, dir2, dir, dir3)
...
def CreateFluxStand(dir=None, dir2='', filename=None):
    # Select Flux standard star
    path = fits.open('../../MaskDesign/{}_mask{}/{}.fits'.format(dir, dir2, filename))
    data = path[1].data
...
# generate Alignment star for LDSS3
# CreateAlignStar(dir='HE0226', filename='HE0226_LS')
CreateAlignStar(dir='HE0439', dir2='2', dir3='l1', filename='HE0439l1_LS')


# Create flux standard
# CreateFluxStand(dir='HE0226', filename='HE0226_gaia+DES+LS')
