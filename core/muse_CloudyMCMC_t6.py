...
# Load cloudy result
Hden = np.arange(-2, 2.5, 0.2) # log # 0.25
metal = np.linspace(-1.5, 0.5, 11, dtype='f2')
alpha = np.linspace(-1.8, 0, 10, dtype='f2')
output, ind = format_cloudy(filename=[metal, alpha], path='/Users/lzq/Dropbox/Data/CGM/cloudy/trial6/')
...
figure.savefig('/Users/lzq/Dropbox/Data/CGM_plots/Cloudy_test_mcmc_S8_t6.pdf', bbox_inches='tight')