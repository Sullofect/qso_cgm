...
def FixCubeHeader(cubename=None):
    path_muse_white = '../../MUSEQuBES+CUBS/test/{}_ESO-DEEP_ZAP_WHITE.fits'.format(cubename)
...
def FixAstrometry(cubename=None, thr_hst=3, thr_muse=3, deblend_hst=False, deblend_muse=True,
    ...
    path_muse_white_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(cubename)
...
def FixCube(cubename=None):
    path_muse_white_gaia_test = '../../MUSEQuBES+CUBS/test/{}_ESO-DEEP_ZAP_gaia_WHITE_astro.fits'.format(
        cubename)
    path_muse_white_gaia_test2 = '../../MUSEQuBES+CUBS/test/{}_ESO-DEEP_ZAP_gaia_WHITE_astro_2.fits'.format(
        cubename)
    path_muse_white_gaia = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(cubename)
...
def FixWithAstrometry(cubename=None, FixHST=False, FixMUSE=True, CheckHST=False, CheckMUSE=False, thr_hst=3, thr_muse=3,
    ...
    path_muse_white_astro = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_gaia_WHITE_astro.fits'.format(cubename)
    path_muse_white_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia_WHITE.fits'.format(cubename)
    path_muse_white_gaia_astro = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia_WHITE_astro.fits'.format(cubename)
    #
...
def FixDatWithAstrometry(cubename=None):
    ...
    #
    path_dat = '../../MUSEQuBES+CUBS/dats/{}_ESO-DEEP_ZAP.dat'.format(cubename)
    path_dat_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia.dat'.format(cubename)
    path_reg_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia.reg'.format(cubename)
    try:
...
def CopyCurrentObjWithAstrometry(cubename=None):
    # Object files
    path_obj = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_spec1D'.format(cubename)
    path_obj_gaia = '../../MUSEQuBES+CUBS/datacubes_gaia/{}_ESO-DEEP_ZAP_gaia_spec1D'.format(cubename)
...
def UpdateHE0238(cubename='HE0238-1904'):
    path_obj = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_spec1D'.format(cubename)
    path_obj_ori = '../../MUSEQuBES+CUBS/datacubes/{}_ESO-DEEP_ZAP_spec1D/ESO_DEEP_offset_zapped_spec1D'.\
        format(cubename)
...
def CopyHeader(f1=None, f2=None):
    path_f1 = '../../MUSEQuBES+CUBS/' + f1
    path_f2 = '../../MUSEQuBES+CUBS/' + f2
...
#                   deblend_hst=False, deblend_muse=True)  # Done!
# FixWithAstrometry(cubename='HE0238-1904', FixHST=False, thr_muse=5, CheckHST=False, CheckMUSE=True,
#                   deblend_hst=False, deblend_muse=True)  # Done!
