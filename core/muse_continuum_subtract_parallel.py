...
parser.add_argument('-s', metavar='s', help='filename to save the subtracted cube to (without .fits)', required=True, type=str)
...
parser.add_argument('-l0', metavar='s', help='upper bound for the emission-line region to mask out when fitting continuum', required=False, type=float, default=-999.0)
parser.add_argument('-l1', metavar='s', help='upper bound for the emission-line region to mask out when fitting continuum', required=False, type=float, default=-999.0)

parser.add_argument('-o', metavar='s', help='Polynomial order', required=False, type=int, default=3)

parser.add_argument('-ra', metavar='ra', help='ra center for subcube (decimal degrees)', required=False, type=float, default=-999.0)
parser.add_argument('-dec', metavar='dec', help='dec center for subcube (decimal degrees)', required=False, type=float, default=-999.0)
parser.add_argument('-radius', metavar='radius', help='dec center for subcube (arcseconds)', required=False, type=float, default=-999.0)
...
cube.primary_header.comments['csub_ra'] = 'RA coordinate center for subtraction subcube (decimal decrees; -999 if not used)'
cube.primary_header['csub_dec'] = args.dec
cube.primary_header.comments['csub_dec'] = 'DEC coordinate center for subtraction subcute (decimal decrees; -999 if not used)'
