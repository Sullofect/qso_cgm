...
newdata = np.rec.array([(6564.61, 'Ha', 6400., 6800., 'Ha_br', 3, 5e-3, 0.004, 0.05, 0.015, 0, 0, 0, 0.05), \
                        ...
                        (4862.68, 'Hb', 4640., 5100., 'Hb_br', 3, 5e-3, 0.001, 0.1, 0.01, 0, 0, 0, 0.01), \
                        (4862.68, 'Hb', 4640., 5100., 'Hb_na', 2, 1e-3, 2.3e-4, 0.01, 0.01, 1, 1, 0, 0.002), \
                        (4960.30, 'Hb', 4640., 5100., 'OIII4960c', 2, 1e-3, 2.3e-4, 0.01, 0.01, 1, 1, 0, 0.002), \
                        (5008.24, 'Hb', 4640., 5100., 'OIII5008c', 2, 1e-3, 2.3e-4, 0.01, 0.01, 1, 1, 0, 0.004), \
